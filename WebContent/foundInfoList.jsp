...
<span style="float:right;font-size:12px;">您现在的位置：主页> 失物招领>>列表</span>
...
<% 
    ...
    ResultSet rs=info.SelectInfos();//倒序查询
    rs.last();//到达集合的最后一行
...
<div class="box" id="box">
        ...
        <span style="color:#AAA;font-size:12px;float:right;"> <%=rs.getString("datetime") %> </span>
          ...
          <img  src="imageFound.jsp?i=<%=i%>" style="width: 80px; height: 80px; border-top-left-radius: 50%; border-top-right-radius: 50%; border-bottom-right-radius: 50%; border-bottom-left-radius: 50%; border: 5px solid rgb(255, 255, 255); display: inline;"></a>
          </div>
