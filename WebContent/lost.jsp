...
<%
 ...
 %>
<h5 style="text-align:center;">发布寻物启事</h5>
<hr style="color:#f00;">
<div class="box">
          <font color="red">${requestScope.error}</font>
          <form action="LostAction" method="post" enctype="multipart/form-data">
          <p>
            <label>标题：</label>
            <input name="title" type="text" id="title" value="输入丢到的物品"  maxlength="100" style='margin-right:35px;' class="intxt" onfocus="inputAutoClear(this)"/>
          </p>
          <div style="text-align:center;padding-left: 47px;color: #f00;"> 在田园食堂丢了一把钥匙<span style=" font-weight:bold; color:#03F;">(示范标题)</span></div>
          <p class="cellBg">
            <label>发布者：</label>
		...
		<p>
		<label>丢物地点：</label><input type="text" name="place" style="width:210px" />
		</p>
		...
		<p>
		  <label>丢物时间：</label><input type='text' name='time' id='dssj' style='width:210px'  class='intxt' value='' />
		</p>
		<p>
