...
<span style="float:right;font-size:12px;">您现在的位置：主页> 寻物启事>>列表</span>

<div style="backgound-color:#003399;width:60px;height:40px;color:#fff;font-size:15px;">

<a href="lost.jsp">发布招领</a>

</div>
</div>
<% 
    InfoService info =new InfoService();
    ResultSet rs=info.SelectLostInfos();//倒序查询
    rs.last();//到达集合的最后一行
...
<div class="box" id="box">
        ...
        <span style="color:#AAA;font-size:12px;float:right;"> <%=rs.getString("datetime") %> </span>
          ...
          <a href="imageLost.jsp" >
          <img  src="imageLost.jsp?i=<%=i%>" style="width: 80px; height: 80px; border-top-left-radius: 50%; border-top-right-radius: 50%; border-bottom-right-radius: 50%; border-bottom-left-radius: 50%; border: 5px solid rgb(255, 255, 255); display: inline;"></a>
          </div>
